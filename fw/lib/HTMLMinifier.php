...
class HTMLMinifier {
	...
	/*public static function minifySave(string $path, string $pathSave, string $prepend = '', string $append = '', array $options = []) {
		$minifier = new TinyHtmlMinifier($options);
		file_put_contents($pathSave, $minifier->minify($prepend.file_get_contents($path).$append));
	}*/
