...
class Element
{
    ...
    /**
     * @var \fw\lib\DiDom\ClassAttribute
     */
    protected $classAttribute;

    /**
     * @var \fw\lib\DiDom\StyleAttribute
     */
     ...
     *
     * @param \fw\lib\DiDom\Element|\DOMNode|array $nodes The prepended child
     *
     * @return \fw\lib\DiDom\Element|\fw\lib\DiDom\Element[]
     *
     * @throws \LogicException if current node has no owner document
     * @throws \InvalidArgumentException if the provided argument is not an instance of \DOMNode or \fw\lib\DiDom\Element
     */
     ...
     *
     * @param \fw\lib\DiDom\Element|\DOMNode|array $nodes The appended child
     *
     * @return \fw\lib\DiDom\Element|\fw\lib\DiDom\Element[]
     *
     * @throws \LogicException if current node has no owner document
     ...
     *
     * @param \fw\lib\DiDom\Element|\DOMNode $node The new node
     * @param \fw\lib\DiDom\Element|\DOMNode|null $referenceNode The reference node
     *
     * @return \fw\lib\DiDom\Element
     *
     * @throws \LogicException if current node has no owner document
     * @throws \InvalidArgumentException if $node is not an instance of \DOMNode or \fw\lib\DiDom\Element
     * @throws \InvalidArgumentException if $referenceNode is not an instance of \DOMNode or \fw\lib\DiDom\Element
     */
     ...
     * @param string $type        The type of the expression
     * @param bool   $wrapElement Returns array of \fw\lib\DiDom\Element if true, otherwise array of \DOMElement
     *
     * @return \fw\lib\DiDom\Element[]|\DOMElement[]
     */
     ...
     * @param string $expression XPath expression or a CSS selector
     * @param string $type       The type of the expression
     * @param bool   $wrapNode   Returns array of \fw\lib\DiDom\Element if true, otherwise array of \DOMElement
     *
     * @return \fw\lib\DiDom\Element[]|\DOMElement[]
     *
     * @throws \LogicException if current node has no owner document
     ...
     * @param string $expression XPath expression or a CSS selector
     * @param string $type       The type of the expression
     * @param bool   $wrapNode   Returns \fw\lib\DiDom\Element if true, otherwise \DOMElement
     *
     * @return \fw\lib\DiDom\Element|\DOMElement|null
     */
     ...
     *
     * @return string|null|\fw\lib\DiDom\Element
     */
    ...
    /**
     * @return \fw\lib\DiDom\ClassAttribute
     *
    ...
    /**
     * @return \fw\lib\DiDom\StyleAttribute
     *
     * @throws \LogicException if the node is not an instance of \DOMElement
     */
     ...
     *
     * @param \fw\lib\DiDom\Element|\DOMNode $node
     *
     * @return bool
     *
    ...
    /**
     * @return \fw\lib\DiDom\Element|\fw\lib\DiDom\Document|null
     */
     ...
     * @param bool $strict
     *
     * @return \fw\lib\DiDom\Element|null
     */
     ...
     *
     * @param \DOMNode|\fw\lib\DiDom\Element $childNode
     *
     * @return \fw\lib\DiDom\Element the node that has been removed
     */
     ...
     *
     * @return \fw\lib\DiDom\Element[] the nodes that has been removed
     */
     ...
     * Replaces a child.
     *
     * @param \DOMNode|\fw\lib\DiDom\Element $newNode The new node
     * @param bool $clone Clone the node if true, otherwise move it
     *
     * @return \fw\lib\DiDom\Element The node that has been replaced
     *
     * @throws \LogicException if current node has no parent node
     */
     ...
     *
     * @return \fw\lib\DiDom\Element The cloned node
     */
     ...
     *
     * @return \fw\lib\DiDom\Document|null
     */
