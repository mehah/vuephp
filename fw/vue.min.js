...
var objectAssignDeep = function() {
	...
	return function objectAssignDeep(target, ...objects) {
...
function clone(obj) {
    ...
    if (null == obj || "object" != typeof obj && "function" != typeof obj) return obj;
    
    if("function" === typeof obj) {
        return function temporary() { return obj.apply(this, arguments); };
    }
...
var VUE_GLOBAL = {
	...
	methods: {
		...
		redirect: function(url, param) {
			...
			this.$http.post(url, param, {emulateJSON: true}).then(({ data }) => {
				updateContent(this.$el, data, url);
		    });
		},
		request: function(url, param, callback) {
			this.$http.post(url, {arg0: JSON.stringify(param)}, {emulateJSON: true}).then(({ data }) => {
				if(data) {
					if(data.d) {
...
window.onpopstate = function(event) {
	Vue.http.post(event.target.location.pathname, null, {emulateJSON: true}).then(({ data }) => {
		eval(data);
    });	  
};
