...
function updateContent(el, html, url) {
	document.body.getElementsByTagName('script')[0].remove();
	
	if(typeof el === 'string') {
		el = document.getElementById(el);
	}
	el.innerHTML = '';
	el.setAttribute("v-html", "HTMLcontent");
	
	var div = document.createElement('div');
	div.insertAdjacentHTML('beforeend', html);
	var text = div.getElementsByTagName('script')[0].innerText;
...
Vue.directive('goto', {
  ...
  inserted: function (el, binding, vnode) {
	  el.addEventListener('click', function(e) {
		  vnode.context.redirect(binding.arg, null, binding.arg);
	  });
  }
});